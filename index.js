...
function finishedAll () {
  ...
  // Notify we're saving
  console.info('Saving final disqus.json file...')
  
  // Does the saving
  fs.writeFileSync('disqus.json', JSON.stringify(disqus_threads))
...
if (fs.existsSync) {
  ...
  console.error('The file disqus.xml was not found. Please, provide a valid uncompressed XML file.')
}